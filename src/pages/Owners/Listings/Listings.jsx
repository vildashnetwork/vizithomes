  ...
  function ListingCard({ listing, loadfetch }) {
    ...
    return (
      <tr
        ...
        <button 
  className="edit" // This allows it to inherit the padding/border-radius from your CSS
  onClick={() => window.location.href = `/updateprop/${listing?._id}`}
  style={{
    background: "linear-gradient(135deg, #10ca8c 0%, #7cb870 100%)",
    color: "white",
    border: "none",
    borderRadius: "8px",
    padding: "8px",
...
>
  <EditIcon style={{ fontSize: "1.2rem" }} />
            ...
            <button
            className="edit" 
             disabled={loadingdel} onClick={handleDelete}
              style={{
    background: "linear-gradient(135deg, #10ca8c 0%, #7cb870 100%)",
    color: "white",
    border: "none",
